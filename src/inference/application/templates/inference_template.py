    ...
    def get_talent_experience_inference_template() -> RichPromptTemplate:
        ...
        template_str = """
            ...
            **관련 뉴스**: 없음
            ...
            성균관대학교, 한양대학교 등 국내 기준 상위권 대학 졸업
            ...
            ### 4. 기술 및 도메인 관련
            - **대용량데이터처리경험**: 빅데이터, AI/ML, 검색엔진, 추천시스템, NLP 등 
            대규모 데이터 처리 기술 경험
            ...
            3. 모든 경력을 시간순 분석
            4. 태그는 relevance 순으로 나열, 중복 없음
            5. 반드시 JSON만 출력, 다른 설명 금지
            ...
            ```json
            {
              ...
              "inference": {
                ...
                "대규모회사경험": "네이버에서 Tech Lead로 재직하며 4,559명 규모의 대기업 환경에서 대규모 검색 서비스의 백엔드 아키텍처를 설계하고 개발했다.",
                ...
                "신규투자유치경험": "벤처스 외 다수의 투자사로 부터 시리즈 B, C, D 투자 유치"
              }
            }
